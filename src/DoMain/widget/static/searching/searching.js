...
const searching = (contents, index) => {
  ...
  document.querySelectorAll(".searchingHidden")[index].value = JSON.stringify(
    widgetObj
  );
  ...
  document.querySelectorAll(".searching")[index].style.fontSize =
    pixelToInt(height) - 40 + "px";
  ...
  document.querySelectorAll(".searchBtn-container")[index].style.width =
    pixelToInt(height) + 8 + "px";
  document.querySelectorAll(".searchBtn-container")[index].style.height =
    pixelToInt(height) + 8 + "px"; // height is same with width
  ...
  document.querySelectorAll(".searchBtn-container img")[index].style.left =
    "50%";
  document.querySelectorAll(".searchBtn-container img")[index].style.transform =
    "translate(-50%, -50%)";
  ...
  setTimeout(() => {
    document
      .querySelectorAll(".searchBtn-container")
